...
export const RenderNode = ({ element }: { element: EditorElement }) => {
    ...
    // État local pour le carrousel (index de la slide active)
    ...
    switch (element.type) {
        case "carousel": {
            ...
            const activeIndex = currentSlide % items.length;
            ...
            return (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ width: '100%', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '0 40px' }}>

                            {currentItem.type === 'image' && (
                                <img
                                    src={currentItem.url || "https://via.placeholder.com/400x300?text=Image"}
                                    alt="Slide"
                                ...
                                <div style={{ width: '100%', height: '100%', minHeight: '250px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    {(currentItem.url && (currentItem.url.includes('youtube') || currentItem.url.includes('youtu.be'))) ? (
                                        <iframe
                                            ...
                                            style={{ width: '100%', height: '100%', border: 'none', ...interactionStyle }}
                                            allowFullScreen
                                        />
                                    ) : (
                                        <video
                                            src={currentItem.url}
                                            controls
                                            style={{ maxWidth: '100%', maxHeight: '100%', ...interactionStyle }}
                                        />
                                    )}
                                </div>
                            )}
                            ...
                            {currentItem.type === 'card' && (
                                <div style={{
                                    ...
                                    <h3 style={{ margin: '0 0 10px 0', color: '#333' }}>{currentItem.title || "Titre"}</h3>
                                    <p style={{ margin: 0, color: '#666', lineHeight: '1.5' }}>{currentItem.description || "Description..."}</p>
                                </div>
                            )}
